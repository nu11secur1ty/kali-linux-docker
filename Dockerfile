...
LABEL org.label-schema.build-date=$BUILD_DATE \
      ...
      org.label-schema.docker.cmd='docker run --rm nu11secur1ty/kali-linux-docker' \
      org.label-schema.docker.cmd.devel='docker run --rm -ti nu11secur1ty/kali-linux-docker' \
